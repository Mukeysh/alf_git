$Id: README.txt,v 1.1 2010/12/09 19:31:15 czingerline Exp $
...
3) Configure the Most Popular settings
  ...
  - Which intervals to use, and in which order to display them.
  - Which services to use, and in which order to display them.
